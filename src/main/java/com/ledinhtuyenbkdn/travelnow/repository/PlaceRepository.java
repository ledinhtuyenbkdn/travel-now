...
public interface PlaceRepository extends Neo4jRepository<Place, Long> {
    ...
    List<Place> findAllByNamePlaceContains(String s, Long page);
    ...
    @Query("match (p:Place)-[r2:IS_BELONGS_TO]->(category:Category)\n" +
            ...
            "OPTIONAL MATCH (p:Place)-[r3:HAS_IMAGE]->(image:Image)  \n" +
            "return r1,r2,r3,p,province,category, image;")
    List<Place> findAllByNamePlaceContainsAndCategoryId(String s, Long id, Long page);
    ...
    @Query("match (p:Place)-[r1:IS_IN]->(province:Province)\n" +
            ...
            "OPTIONAL MATCH (p:Place)-[r3:HAS_IMAGE]->(image:Image)  \n" +
            "return r1,r2,r3,p,province,category, image;")
    List<Place> findAllByNamePlaceContainsAndProvinceId(String s, Long id, Long page);
    ...
    @Query("match (p:Place)-[r1:IS_IN]->(province:Province), \n" +
            ...
            "OPTIONAL MATCH (p:Place)-[r3:HAS_IMAGE]->(image:Image) \n" +
            "return r1,r2,r3,p,province,category, image;")
    List<Place> findAllByNamePlaceContainsAndProvinceIdAndCategoryId(String s, Long provinceId, Long categoryId, Long page);
